...
## The cinematic world comes from the provider seam (P17-lite) — same contract as
## reveal_scene.gd: mesh interior by default, the GDGS splat route swappable behind it.
