...
- ⬜ [**P13b**](P13b-city-life-vfx.md) — Rain/wet-surface VFX + traffic + crowd proxy (MultiMesh, spline traffic) — *not started; wet-surface shader/reflection exists but no rain particles / traffic / crowd yet*
- ⬜ [**P14b**](P14b-characters-roster.md) — Aiko canonical references + 4 character base models + shared animation prototype + roster screen — *not started*
